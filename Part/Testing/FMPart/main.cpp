/**
 * This example shows that if we restrict the number of moves
 * per pass to say 9/10, the quality of result will be affected
 * significantly in flat mode.
 */
#include <FMParam.hpp>
...
int main(int argc, const char* argv[])
{
  ...
  for (int i=17; i<18; i++) {
    ...
    try {
    srand(1);
    FMPartTmpl<FMBiPartCore, FMBiGainMgr2> P(param);  
